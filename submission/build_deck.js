 ...
 *
 * 🔴 2026-08-02: 이 스크립트는 **실제 제출본을 만들지 않는다.**
 *    같은 디렉터리의 `기술설명서_KB_Payee_Guard.pptx` 는 별도 도구로 만든
 *    상세판(표 13개 · 그림 1개 · 장별 출처 각주)이며 그쪽이 제출본이다.
 *    이 스크립트를 실행하면 그 파일을 **더 단순한 판으로 덮어쓴다.**
 *    참고용으로만 남겨두며, 제출본 수정은 pptx 를 직접 편집한다.
 *
